...
class BaspiNodeOne(polyinterface.Node):
    def __init__(self, controller, primary, address, name, ipaddress, bc):
        super(BaspiNodeOne, self).__init__(controller, primary, address, name)
    ...
    def start(self):
        ...
        if self.bc.ePlatform == Platform.BASC_PO:
            LOGGER.info('Connected to BASpi6U6R Module One')
        ...
        # Input/Output Status
        LOGGER.info('UI 1' + '\t' + str(self.bc.universalInput(1)))
        LOGGER.info('UI 2' + '\t' + str(self.bc.universalInput(2)))
        LOGGER.info('UI 3' + '\t' + str(self.bc.universalInput(3)))
        LOGGER.info('UI 4' + '\t' + str(self.bc.universalInput(4)))
        LOGGER.info('UI 5' + '\t' + str(self.bc.universalInput(5)))
        LOGGER.info('UI 6' + '\t' + str(self.bc.universalInput(6)))
        LOGGER.info('BO 1' + '\t' + str(self.bc.binaryOutput(1)))
        LOGGER.info('BO 2' + '\t' + str(self.bc.binaryOutput(2)))
        LOGGER.info('BO 3' + '\t' + str(self.bc.binaryOutput(3)))
        LOGGER.info('BO 4' + '\t' + str(self.bc.binaryOutput(4)))
        LOGGER.info('BO 5' + '\t' + str(self.bc.binaryOutput(5)))
        LOGGER.info('BO 6' + '\t' + str(self.bc.binaryOutput(6)))
